...
public class SysRoleController extends BaseController {
    ...
    @PostMapping
    public AjaxResult<Integer> add(@Validated @RequestBody SysRole role) {
    ...
    @PutMapping
    public AjaxResult<Integer> edit(@Validated @RequestBody SysRole role) {
    ...
    public AjaxResult<Integer> dataScope(@RequestBody SysRole role) {
        roleService.checkRoleAllowed(role);
    ...
    public AjaxResult<Integer> changeStatus(@RequestBody SysRole role) {
        roleService.checkRoleAllowed(role);
        role.setUpdateBy(SecurityUtils.getUsername());
    ...
    public AjaxResult<Integer> remove(@PathVariable Long[] roleIds) {
