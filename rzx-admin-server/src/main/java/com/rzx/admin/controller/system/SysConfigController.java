...
import com.rzx.project.system.domain.SysConfig;
...
import com.rzx.common.annotation.RepeatSubmit;
...
public class SysConfigController extends BaseController {
    ...
    @PostMapping
    @RepeatSubmit
    public AjaxResult<Integer> add(@Validated @RequestBody SysConfig config) {
    ...
    @PutMapping
    public AjaxResult<Integer> edit(@Validated @RequestBody SysConfig config) {
        if (UserConstants.NOT_UNIQUE.equals(configService.checkConfigKeyUnique(config))) {
