...
import com.rzx.project.system.service.ISysPostService;
import com.rzx.project.system.service.ISysRoleService;
...
import com.rzx.common.core.domain.entity.SysRole;
...
public class SysUserController extends BaseController {
    ...
    @PostMapping
    public AjaxResult<Integer> add(@Validated @RequestBody SysUser user) {
    ...
    @PutMapping
    public AjaxResult<Integer> edit(@Validated @RequestBody SysUser user) {
    ...
    public AjaxResult<Integer> remove(@PathVariable Long[] userIds) {
    ...
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @PutMapping("/resetPwd")
    public AjaxResult<Integer> resetPwd(@RequestBody SysUser user) {
        userService.checkUserAllowed(user);
        user.setPassword(SecurityUtils.encryptPassword(user.getPassword()));
        user.setUpdateBy(SecurityUtils.getUsername());
    ...
    public AjaxResult<Integer> changeStatus(@RequestBody SysUser user) {
        userService.checkUserAllowed(user);
        user.setUpdateBy(SecurityUtils.getUsername());
