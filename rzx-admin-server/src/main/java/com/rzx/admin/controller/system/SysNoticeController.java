...
import com.rzx.project.system.domain.SysNotice;
import com.rzx.project.system.service.ISysNoticeService;
...
public class SysNoticeController extends BaseController {
    ...
    @PostMapping
    public AjaxResult<Integer> add(@Validated @RequestBody SysNotice notice) {
    ...
    @PutMapping
    public AjaxResult<Integer> edit(@Validated @RequestBody SysNotice notice) {
    ...
    public AjaxResult<Integer> remove(@PathVariable Long[] noticeIds) {
