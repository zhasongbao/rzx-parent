...
public class SysDeptController extends BaseController {
    ...
    @PostMapping
    public AjaxResult<Integer> add(@Validated @RequestBody SysDept dept) {
    ...
    @PutMapping
    public AjaxResult<Integer> edit(@Validated @RequestBody SysDept dept) {
        if (UserConstants.NOT_UNIQUE.equals(deptService.checkDeptNameUnique(dept))) {
    ...
    public AjaxResult<Integer> remove(@PathVariable Long deptId) {
