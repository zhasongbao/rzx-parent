...
import com.rzx.project.system.service.ISysDictDataService;
...
public class SysDictDataController extends BaseController {
    ...
    @PostMapping
    public AjaxResult<Integer> add(@Validated @RequestBody SysDictData dict) {
    ...
    @PutMapping
    public AjaxResult<Integer> edit(@Validated @RequestBody SysDictData dict) {
